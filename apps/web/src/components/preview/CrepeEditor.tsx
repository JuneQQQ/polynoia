...
export function CrepeEditor({
	...
	// state once mounted.
	// biome-ignore lint/correctness/useExhaustiveDependencies: re-mount only on path; content is seeded at construction and the editor owns its state after (re-feeding would fight the cursor).
	useEffect(() => {
	...
	const save = useCallback(async () => {
		...
		try {
			...
			// The code editor keeps its OWN buffer; nudge it to re-read this file from
