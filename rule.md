...
| 维度 | 权重 | 交付证据 |
|---|---:|---|
| AI 协作能力 | 30% | `CLAUDE.md`, `docs/ai-collaboration.md`, `docs/superpowers/specs/`, `docs/ADR/`, `docs/research/`, `scripts/testkit/reset.sh` |
...
- 上线准备/回归测试初始化脚本:`scripts/testkit/reset.sh`
